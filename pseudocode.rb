...
When the person says something, and it has lower case letters, respond with I AM HAVING A HARD TIME HEARING YOU.

# If you ask a question in all upper-case letters, they respond with NO, THIS IS NOT A PET STORE
When the person says something, and it has no lower case letters, respond with NO, THIS IS NOT A PET STORE

# The first time you say GOODBYE! they say ANYTHING ELSE I CAN HELP WITH?
When the person says Goodbye! and they have not said it before, respond with ANYTHING ELSE I CAN HELP WITH?

# The second time you say GOODBYE! they say THANK YOU FOR CALLING! and the program exits.
When the person says Goodbye! and they have said it before, respond with THANK YOU FOR CALLING! and exit
